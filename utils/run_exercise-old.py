...
class ExerciseRunner:
    ...
    def get_port_from_route(routt_lists):
        pass
    

    def find_route(self, source_name, dest_name):
        ports = ""
        source_host = get_host_from_list(source_name)
        dest_host =  get_host_from_list(dest_name)

        source_switch = source_host.nextSwitch
        dest_switch = dest_host.nextSwitch
        return ports
    ...
    def test(self):
        ...
        ports = find_route(source_name, dest_name)
